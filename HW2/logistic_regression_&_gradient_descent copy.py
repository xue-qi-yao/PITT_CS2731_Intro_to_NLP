...
class LogisticRegression():
    ...
    def train(self):
        ...
        for i in range(self.num_iter):
            ...
            self.a -= self.lr * np.sum(self.x.T * (self.pred.T - self.y.T), axis=0, keepdims=True)
            self.b -= self.lr * np.sum((self.pred.T-self.y.T), axis=0, keepdims=True) 
...
# The synthetic data 1 accuracy converge around 30 rounds
# The synthetic data 3 accuracy converge around 30 rounds
# The synthetic data 2 accuracy converge around 30 rounds